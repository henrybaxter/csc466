...
\centering
\begin{tabular}{c c}
	\includegraphics[width=.4\textwidth]{{plots/local/object-size}.eps} &
	\includegraphics[width=.4\textwidth]{{plots/local/object-count}.eps}	\\
	\includegraphics[width=.4\textwidth]{{plots/local/rate-limit}.eps}	&
	\includegraphics[width=.4\textwidth]{{plots/local/packet-loss}.eps}	\\
	\multicolumn{2}{c}{\includegraphics[width=.4\textwidth]{{plots/local/latency}.eps}}
\end{tabular}
...
\centering
\begin{tabular}{c c}
	\includegraphics[width=.4\textwidth]{{plots/ec2/object-size}.eps} &
	\includegraphics[width=.4\textwidth]{{plots/ec2/object-count}.eps}	\\
	\includegraphics[width=.4\textwidth]{{plots/ec2/rate-limit}.eps}	&
	\includegraphics[width=.4\textwidth]{{plots/ec2/packet-loss}.eps}	\\
	\multicolumn{2}{c}{\includegraphics[width=.4\textwidth]{{plots/ec2/latency}.eps}}
\end{tabular}
\caption{EC2 Testbed}
\label{figs:ec2}
\end{figure}
